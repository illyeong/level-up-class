...
namespace Assets.FantasyMonsters.Bosses.Scripts.Editor
{
    [InitializeOnLoad]
    internal static class PackageFeedback
    {
        private const string PackageId = "300879";
        private const string PackageName = "Fantasy Monsters Animated [Bosses]";
