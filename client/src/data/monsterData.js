...
/** 보스 ID → 배경 이미지 경로 */
export const BOSS_BG_MAP = {
  wyvernType1:      '/images/boss-bg/boss-bg-Wyvern1.png',
  wyvernType2:      '/images/boss-bg/boss-bg-Wyvern2.png',
  wyvernType3:      '/images/boss-bg/boss-bg-Wyvern3.png',
  wyvernType4:      '/images/boss-bg/boss-bg-Wyvern4.png',
  wyvernType5:      '/images/boss-bg/boss-bg-Wyvern5.png',
  wyvernType6:      '/images/boss-bg/boss-bg-Wyvern6.png',
  wyvernType7:      '/images/boss-bg/boss-bg-Wyvern7.png',
  wyvernType8:      '/images/boss-bg/boss-bg-Wyvern8.png',
  wyvernType9:      '/images/boss-bg/boss-bg-Wyvern9.png',
  wyvernType10:     '/images/boss-bg/boss-bg-Wyvern10.png',
  blackDragon:      '/images/boss-bg/boss-bg-BlackDragon.png',
  emeraldDragon:    '/images/boss-bg/boss-bg-emeralddragon.png',
  goldenDragon:     '/images/boss-bg/boss-bg-goldendragon.png',
  greenDragon:      '/images/boss-bg/boss-bg-greendragon.png',
  greyDragon:       '/images/boss-bg/boss-bg-greydragon.png',
  iceDragon:        '/images/boss-bg/boss-bg-icedragon.png',
  mechanicalDragon: '/images/boss-bg/boss-bg-MechanicalDragon.png',
  purpleDragon:     '/images/boss-bg/boss-bg-PurpleDragon.png',
  redDragon:        '/images/boss-bg/boss-bg-RedDragon.png',
  lizard03:         '/images/boss-bg/boss-bg-lizard.png',
  demon02:          '/images/boss-bg/boss-bg-demon.png',
  demon03:          '/images/boss-bg/boss-bg-demon.png',
  croc03:           '/images/boss-bg/boss-bg-croco.png',
  megabear01:       '/images/boss-bg/boss-bg-MegaBear.png',
  megabear02:       '/images/boss-bg/boss-bg-MegaBear.png',
  megabear03:       '/images/boss-bg/boss-bg-MegaBear.png',
  minotaur02:       '/images/boss-bg/boss-bg-Minotauro.png',
  minotaur03:       '/images/boss-bg/boss-bg-Minotauro.png',
  iceGolem:         '/images/boss-bg/boss-bg-IceGolem.png',
  mechanicalGolem:  '/images/boss-bg/boss-bg-MechanicalGolem.png',
  rockGolem:        '/images/boss-bg/boss-bg-RockGolem.png',
  sandGolem:        '/images/boss-bg/boss-bg-SandGolem.png',
  stoneGolem:       '/images/boss-bg/boss-bg-StoneGolem.png',
  volcanoGolem:     '/images/boss-bg/boss-bg-VolcanoGolem.png',
  fancyWorm:        '/images/boss-bg/boss-bg-fancyworm.png',
  greenWorm:        '/images/boss-bg/boss-bg-greenworm.png',
  iceWorm:          '/images/boss-bg/boss-bg-iceworm.png',
  mechanicalWormA:  '/images/boss-bg/boss-bg-MechanicalWorm.png',
  mechanicalWormB:  '/images/boss-bg/boss-bg-MechanicalWorm.png',
  mosquitoWorm:     '/images/boss-bg/boss-bg-MosquitoWorm.png',
