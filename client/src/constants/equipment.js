...
export const CHESTS = [
  {
    id: 'wood', name: '나무 상자', icon: '🪵', cost: 50,
    rates: { legendary: 1, epic: 5, rare: 25, common: 69 },
  },
  {
    id: 'stone', name: '돌 상자', icon: '🪨', cost: 150,
    rates: { legendary: 5, epic: 15, rare: 40, common: 40 },
  },
  {
    id: 'diamond', name: '다이아 상자', icon: '💎', cost: 500,
    rates: { legendary: 15, epic: 30, rare: 35, common: 20 },
  },
];
