...
const ETF_LIST = [
  ...
  },
  {
    ...
    name: '비트코인 ETF',
    theme: '암호화폐',
    description: 'BlackRock이 운용하는 비트코인 현물 ETF입니다. 비트코인 가격을 그대로 추종하며 높은 변동성과 함께 강력한 상승 잠재력을 가집니다. 배당은 없습니다.',
    dividendRate: 0,
    currency: 'gold',
    basePrice: 55,
  },
  // ─── 한국 ETF (KRW ÷ 1000 = game gold) ──────────────────────
  {
    id: 'k_semiconductor',
    symbol: '091160.KS',
    name: 'KODEX 반도체',
    theme: '한국주식',
    description: '삼성전자, SK하이닉스 등 국내 반도체 대표 기업들에 투자합니다. 글로벌 AI 수요 증가로 주목받는 K-반도체 섹터입니다.',
    dividendRate: 0.004,
    currency: 'gold',
    basePrice: 45,
  },
  {
    ...
    name: 'KODEX 2차전지',
    theme: '한국주식',
    description: 'LG에너지솔루션, 삼성SDI, SK온 등 전기차 배터리 핵심 기업에 투자합니다. 전기차 시대의 핵심 소재를 담당합니다.',
    dividendRate: 0.003,
    currency: 'gold',
    basePrice: 14,
  },
  {
    ...
    name: 'KODEX 헬스케어',
    theme: '한국주식',
    description: '셀트리온, 삼성바이오로직스, 한미약품 등 바이오·제약 선도 기업에 투자합니다.',
    dividendRate: 0.005,
    currency: 'gold',
    basePrice: 18,
  },
  {
    ...
    name: 'KODEX 200',
    theme: '한국주식',
    description: '코스피 대형주 상위 200개 기업에 분산 투자합니다. 한국 경제 전체를 대표하는 가장 안정적인 ETF입니다.',
    dividendRate: 0.006,
    currency: 'gold',
    basePrice: 32,
  },
  {
    ...
    name: '삼성전자',
    theme: '한국주식',
    description: '반도체, 스마트폰, 가전을 아우르는 세계 최대 IT 기업 중 하나입니다. 안정적인 배당과 함께 글로벌 성장을 추구합니다.',
    dividendRate: 0.007,
    currency: 'gold',
    basePrice: 75,
  },
